...
public class StaffRegister extends BaseActivity {
    ...
    private void registerUser() {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
                Appconfig.STAFF_CREATE, new Response.Listener<String>() {
            @Override
                    ...
                    public void onResponse(JSONObject localJSONObject1) {
                        ...
                        try {
                            if (localJSONObject1.getInt("success") == 1) {
                                ...
                                ArrayAdapter<String> districtAdapter = new ArrayAdapter<String>(StaffRegister.this,
                                        android.R.layout.simple_dropdown_item_1line, STOREID);
