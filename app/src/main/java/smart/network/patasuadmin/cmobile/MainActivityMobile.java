...
public class MainActivityMobile extends AppCompatActivity implements MobileAdapter.StaffAdapterListener {
    ...
    private static final String URL = Appconfig.ip + "/admin/staff/dataFetchStaffAll.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MobileAdapter(this, contactList, this);
        ...
        addStock.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivityMobile.this, MobileRegister.class);
        ...
        JsonObjectRequest request = new JsonObjectRequest(URL, new JSONObject(),
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            List<Cmobile> items = new Gson()
                                    .fromJson(response.getJSONArray("data").toString(),
                                            new TypeToken<List<Cmobile>>() {
                                            }.getType());
    ...
    @Override
    public void onStaffSelected(Cmobile contact) {
        Intent intent = new Intent(MainActivityMobile.this, MobileRegister.class);
